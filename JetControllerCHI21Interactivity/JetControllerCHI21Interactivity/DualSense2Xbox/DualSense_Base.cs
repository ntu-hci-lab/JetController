...
using JetControllerCHI21Interactivity;
...
namespace DualSense2Xbox
{
    abstract partial class DualSense_Base
    {
        ...
        private void Controller_FeedbackReceived(object sender, Xbox360FeedbackReceivedEventArgs e)
        {
            ...
            HapticController.SignalFlow.Post(new HapticController.Status { Byte1 = e.SmallMotor, Byte2 = e.LargeMotor, IsVibrationPacket = true });
        }
